...
我们以示例的形式向开发者展示如何实现<strong>语音识别</strong>（语音转文字）、<strong>语音生成</strong>（文字转语音）等基础功能。还展示了如何结合大语言模型（包括通义千问、百川、月之暗面、零一万物、MiniMax等）来实现<strong>语音聊天对话</strong>、<strong>语音分析理解</strong>、<strong>语音翻译</strong>等高阶AI功能。开发者可以方便的将本仓库中的示例集成进自己的项目中进行进一步开发。
